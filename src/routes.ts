...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/cards',
            ...
            async function CardsController_getCards(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller: any = await container.get<CardsController>(CardsController);
        ...
        app.post('/cards',
            ...
            async function CardsController_createCard(request: any, response: any, next: any) {
            const args = {
            };
